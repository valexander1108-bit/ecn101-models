...
def app():
    ...
    if show_adv:
        st.markdown(
            r"""
**Frontier equation:** \((x/a)^k + (y/b)^k = 1 \Rightarrow y(x) = b\,[1-(x/a)^k]^{1/k}\)  
**Slope at point:** \( \frac{dy}{dx} \lt 0\) on the PPF  
**Opportunity cost of X at the point:** \( \text{OC}_{X} = -\frac{dy}{dx} \) (units of Y per +1 X)
            """
        )
